...
app.use('/api/ngos', require('./routes/Ngo')); app.use('/user', require('./routes/ContactUs')); app.use('/api/faq', require('./routes/faq')); app.use('/user', require('./routes/user')); app.use('/api/donations', require('./routes/donation')); app.use('/api/upload', require('./routes/upload')); app.use('/feedback/user', require('./routes/feedback')); app.use('/api/ai', require('./routes/ai')); app.use('/api/webhooks', require('./routes/webhooks')); app.use('/api', require('./routes/automation'));
